...
namespace LenguageBlazorSignalR.Server
{
    ...
    {
        private readonly LenguageBlazorSignalRServerContext _context;

        public ProgrammingLanguagesController(LenguageBlazorSignalRServerContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.ProgrammingLanguage.AsNoTracking().ToListAsync();
        }
